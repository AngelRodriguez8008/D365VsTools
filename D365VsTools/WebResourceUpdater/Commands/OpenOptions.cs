...
namespace D365VsTools.WebResourceUpdater.Commands
{
    ...
    internal sealed class OpenOptions
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenOptions"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private OpenOptions(Package package)
        {
        ...
        /// </summary>
        public static OpenOptions Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new OpenOptions(package);
        }
